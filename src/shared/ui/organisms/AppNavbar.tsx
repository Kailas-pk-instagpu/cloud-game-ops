...
export function AppNavbar() {
  ...
  return (
    <header className="sticky top-2 z-40 ml-0 mr-2 mt-2 h-14 rounded-2xl border border-border/60 dark:border-sidebar-border bg-background/70 dark:bg-sidebar/80 backdrop-blur-xl shadow-lg shadow-black/5 flex items-center justify-between px-4">
