...
export function AppNavbar() {
  ...
  return (
    <header className="sticky top-2 z-40 ml-0 mr-2 mt-2 h-14 border-border/20 dark:border-sidebar-border/20 bg-background/10 dark:bg-sidebar/10 backdrop-blur-md flex items-center justify-between px-4 border-2 rounded-none">
